...
from PyQt5.QtWidgets import QDoubleSpinBox, QSpinBox, QLabel, QWidget, QStackedWidget, QPushButton, QGridLayout, \
    QLayout, QVBoxLayout, QHBoxLayout, QFrame, QLayoutItem, QSizePolicy, QLineEdit, QAbstractSpinBox
...
class FormLayoutWithIcon(QGridLayout):
    ...
    def add_row(self, label: QWidget, field: Optional[Union[QLineEdit, QAbstractSpinBox]] = None, icon: Optional[QWidget] = None):
        if field is None:
